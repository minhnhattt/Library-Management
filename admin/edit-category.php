...
<head>
    ...
    <title>HỆ THỐNG QUẢN LÝ THƯ VIỆN | Chỉnh sửa danh mục sách</title>
                                ...
                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if ($result->Status == 1) { ?>
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="status" id="status" value="0">Đóng
                                                    </label>
                                                </div>
                                            <?php } else { ?>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="status" id="status" value="0" checked="checked">Đóng
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
