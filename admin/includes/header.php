        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    ...
                    <img src="assets/img/logo.png" class="logo_library"/>
                </a>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Danh mục sách <i class="fa fa-angle-down"></i></a>
                           ...
                           <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Phiếu mượn <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="issue-book.php">Thêm phiếu mượn</a></li>
